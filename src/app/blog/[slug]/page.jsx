...
import { CustomHeading } from '@/component/CustomHeading'; // Asegúrate de importar CustomHeading
import Image from 'next/image';
import { getBlog } from '@/utils/getBlogsData';
  ...
  try {
    ...
    return (
        ...
        <div className="my-12 text-start p-4">
          ...
          {/* Información del autor con borde inferior */}
